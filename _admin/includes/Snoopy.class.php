...
class Snoopy
{
	...
	var	$curl_path		=	"E:/PHP/curl/curl.exe";
...
\*======================================================================*/
	...
	if($i){
		...
		//--------------------
		if($info['http_code']!=0){
			$result_headers = explode("\n",substr($results,0,$info['header_size']));
			$results = substr($results,$info['header_size']);
		}
	}else{
		$headerfile = tempnam($temp_dir, "sno");
		$datafile = tempnam($temp_dir, "snd");
		
		// 初始化 $result_headers 变量为一个空数组
		...
		$results = file_get_contents("$datafile");
